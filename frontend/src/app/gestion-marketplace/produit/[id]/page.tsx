  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      <div className="container mx-auto px-4 py-8">
        <Link href="/gestion-marketplace" className="inline-flex items-center gap-2 text-gray-400 hover:text-amber-400 mb-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="rounded-3xl overflow-hidden border border-white/10 bg-white/5 relative group"
          >
            {product.model3d_url ? (
              <ProductViewer3D 
              ...
              <img src={product.image_url} alt={product.nom} className="w-full h-auto object-cover" />
            ) : (
          ...
          >
            <div>
              ...
              <h1 className="text-3xl font-bold text-white mb-4">{product.nom}</h1>
            ...
            <div className="p-4 rounded-2xl bg-blue-500/10 border border-blue-500/30">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white">Emplacement du produit</p>
                  <p className="text-xs text-blue-300">{emplacement.adresse}</p>
                  <p className="text-xs text-gray-400">{emplacement.ville}</p>
                </div>
              </div>
              <button
              ...
              >
                <div className="h-64 bg-gray-800/50 relative">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                    ...
                    <p className="text-sm text-white mt-2">{emplacement.ville}</p>
                    <p className="text-xs text-gray-400">{emplacement.adresse}</p>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            <div className="grid grid-cols-2 gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-500">Poids unitaire</p>
                  <p className="text-sm font-medium text-white">{(product as any).poids_kg || 1000} kg</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white">{(product as any).dimensions || "120x80x100 cm"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/20">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-10 h-10 rounded-xl bg-white/10 text-white hover:bg-white/20"
                >
                  -
                </button>
