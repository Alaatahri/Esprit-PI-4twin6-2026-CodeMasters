      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bmp-icon-gradient flex items-center justify-center">
        ...
        >
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl bg-muted border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-amber-500/50"
            />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((product, i) => (
            <motion.article
              ...
              className="group overflow-hidden rounded-2xl border border-border bg-card shadow-bmp-sm backdrop-blur-sm transition-all duration-300 hover:border-brand/35 hover:shadow-bmp-md"
            >
              <div className="relative aspect-[4/3] overflow-hidden bg-muted">
                ...
                <div className="absolute top-3 left-3">
                  <span className="rounded-lg bg-card/95 px-2.5 py-1 text-xs text-body-secondary shadow-bmp-xs backdrop-blur-sm dark:bg-background/80">
                    {product.category}
                  </span>
                </div>
                <div className="absolute right-3 top-3 flex items-center gap-1 rounded-lg bg-card/95 px-2 py-1 shadow-bmp-xs backdrop-blur-sm dark:bg-background/80">
              ...
              <div className="p-5">
                <h3 className="mb-1 line-clamp-2 font-semibold text-foreground transition-colors group-hover:text-brand dark:group-hover:text-amber-200">
                  {product.name}
                </h3>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <span className="text-2xl font-bold text-amber-400">
                      {product.price.toFixed(2)} <span className="text-sm font-normal text-muted-foreground">TND</span>
                    </span>
                    <span className="text-xs text-muted-foreground block">/ {product.unit}</span>
                  </div>
                  <button
                    type="button"
                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl bmp-btn-primary font-semibold hover:shadow-lg transition-all"
                  >
        ...
        >
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-muted border border-border text-foreground font-medium hover:bg-accent hover:border-amber-500/30 transition-all"
          >
            Se connecter
