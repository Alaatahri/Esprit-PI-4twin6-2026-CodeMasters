...
import { PaymentForm, PaymentData } from '@/components/marketplace/PaymentForm';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Finalisez votre commande en toute sécurité</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <div className="space-y-3 mb-6">
                <label className="flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all bg-white/5 border-white/10 hover:border-amber-500/30">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="font-medium text-white">Paiement complet</p>
                      <p className="text-xs text-gray-500">Payer la totalité maintenant</p>
                    </div>
                  </div>
                ...
                <label className="flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all bg-white/5 border-white/10 hover:border-amber-500/30">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="font-medium text-white">50% maintenant / 50% à la livraison</p>
                      <p className="text-xs text-gray-500">Payer la moitié maintenant, le reste à la réception</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-lg font-bold text-amber-400">{(total / 2).toFixed(2)} TND</span>
                    <p className="text-xs text-gray-500">+ {(total / 2).toFixed(2)} TND à la livraison</p>
                  </div>
                </label>
              </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 sticky top-24">
              ...
              <div className="border-t border-white/10 pt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">{deliveryPrice.toFixed(2)} TND</span>
                </div>
                {distance > 0 && (
