      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h1 className="text-2xl font-bold text-white mb-6">Mon panier ({items.length} article{items.length > 1 ? 's' : ''})</h1>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-white mb-1">{item.nom}</h3>
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="w-8 text-center text-white">{item.quantite}</span>
                      <button
                        onClick={() => updateQuantity(item.productId, item.quantite + 1)}
                        className="w-8 h-8 rounded-lg bg-white/10 text-white hover:bg-white/20 transition-colors flex items-center justify-center"
                      >
            ...
            <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Comparez les prix et choisissez le livreur qui vous convient</p>
                </div>
              </div>
            </div>
          </div>
