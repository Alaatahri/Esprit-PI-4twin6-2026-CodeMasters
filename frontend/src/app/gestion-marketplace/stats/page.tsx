...
export default function StatsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background text-foreground dark:bg-gradient-to-b dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 dark:text-white flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 rounded-full border-2 border-amber-500/50 border-t-amber-400 animate-spin" />
          <p className="text-muted-foreground dark:text-gray-400">Chargement des statistiques...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-foreground dark:text-white">Statistiques Marketplace</h1>
          </div>
          <p className="text-muted-foreground dark:text-gray-500">Analyse des ventes, performances et tendances</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="rounded-2xl border border-border bg-card/60 p-6 dark:border-white/10 dark:bg-white/5">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-foreground dark:text-white">Produits les plus vendus</h2>
            </div>
            <div className="space-y-4">
              {topProduits.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-3 rounded-xl bg-muted/40 dark:bg-white/5"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground dark:text-white">{item.produit?.nom || 'Produit'}</p>
                      <div className="flex items-center gap-2 text-xs">
                        <span className="text-muted-foreground dark:text-gray-500">{item.totalVendus} vendus</span>
                        <div className="flex items-center gap-1">
                          <Star className="w-3 h-3 text-yellow-400" />
                          <span className="text-foreground dark:text-white">{item.noteMoyenne || 'Nouveau'}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-xs text-muted-foreground dark:text-gray-500">CA généré</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="rounded-2xl border border-border bg-card/60 p-6 dark:border-white/10 dark:bg-white/5">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-foreground dark:text-white">Livreurs les plus demandés</h2>
            </div>
            <div className="space-y-4">
              {topLivreurs.map((item, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground dark:text-white">{item.vehicle?.nom || 'Livreur'}</p>
                      <div className="flex items-center gap-2 text-xs">
                        <span className="text-muted-foreground dark:text-gray-500">{item.nombreLivraisons} livraisons</span>
                        <div className="flex items-center gap-1">
                          <Star className="w-3 h-3 text-yellow-400" />
                          <span className="text-foreground dark:text-white">{item.noteMoyenne || 'Nouveau'}/5</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="rounded-2xl border border-border bg-card/60 p-6 dark:border-white/10 dark:bg-white/5">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-foreground dark:text-white">Ventes par jour</h2>
            </div>
            <div className="space-y-3">
              {ventesData?.ventesParJour?.slice(-7).map((jour) => (
                <div key={jour._id} className="flex items-center gap-4">
                  <span className="text-sm text-muted-foreground dark:text-gray-400 w-24">{jour._id}</span>
                  <div className="flex-1 h-8 bg-muted/40 dark:bg-white/10 rounded-full overflow-hidden">
                    <div
                  ...
                  <span className="text-sm text-foreground dark:text-white w-16 text-right">{jour.count} cmd</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card/60 p-6 dark:border-white/10 dark:bg-white/5">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-foreground dark:text-white">Performance générale</h2>
            </div>
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-muted-foreground dark:text-gray-400">Satisfaction client</span>
                  <span className="text-foreground dark:text-white">{globalStats?.noteMoyenneService || 0}/5</span>
                </div>
                <div className="w-full h-2 bg-muted/40 dark:bg-white/10 rounded-full overflow-hidden">
                  <div
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-muted-foreground dark:text-gray-400">Taux de conversion</span>
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-muted-foreground dark:text-gray-400">Livraisons réussies</span>
                  <span className="text-foreground dark:text-white">98%</span>
                </div>
                <div className="w-full h-2 bg-muted/40 dark:bg-white/10 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full" style={{ width: '98%' }} />
                </div>
              </div>
              <div className="pt-4 mt-2 border-t border-border/60 dark:border-white/10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Users className="w-4 h-4 text-muted-foreground dark:text-gray-500" />
                    <span className="text-sm text-muted-foreground dark:text-gray-400">Total avis</span>
                  </div>
                  <span className="text-foreground dark:text-white font-bold">{globalStats?.totalAvis || 0}</span>
                </div>
              </div>
            </div>
          </div>
...
function StatCard({ title, value, icon, color }: { title: string; value: string | number; icon: React.ReactNode; color: string }) {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card/60 p-6 dark:border-white/10 dark:bg-white/5">
      ...
      <p className="text-sm text-muted-foreground dark:text-gray-500 mt-1">{title}</p>
    </div>
  );
}