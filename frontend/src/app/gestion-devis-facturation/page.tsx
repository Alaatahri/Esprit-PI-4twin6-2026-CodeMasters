  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-foreground dark:text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 sm:py-24">
        <Link href="/" className="inline-flex items-center gap-2 text-muted-foreground dark:text-gray-400 hover:text-amber-700 dark:text-amber-300 mb-12 transition-colors">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-400 flex items-center justify-center mx-auto mb-8">
            <FileText className="w-10 h-10 text-foreground dark:text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground dark:text-white mb-4">Devis & Facturation IA</h1>
