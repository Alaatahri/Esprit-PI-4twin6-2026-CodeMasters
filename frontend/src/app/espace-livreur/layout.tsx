...
export default function DriverLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex text-white">
      {/* Sidebar */}
      <aside className={`${isSidebarOpen ? 'w-64' : 'w-20'} bg-gray-900 border-r border-white/10 transition-all duration-300 flex flex-col`}>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-16 border-b border-white/10 bg-gray-900/50 backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-40">
          <button 
