    ...
    <div className="p-6 space-y-8 pb-20">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Analysez vos performances et suivez vos gains en temps réel.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <p className="text-xs text-gray-500 uppercase font-bold tracking-widest mt-1">{stat.label}</p>
          </motion.div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 p-8 rounded-[2.5rem] bg-white/5 border border-white/10 relative overflow-hidden">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-lg font-black text-white">Évolution des gains</h3>
            <div className="flex gap-2">
              <span className="w-3 h-3 rounded-full bg-amber-500"></span>
              <span className="text-[10px] text-gray-500 font-bold uppercase">TND / Jour</span>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10">
            <h3 className="text-lg font-black text-white mb-6">Activité récente</h3>
            <div className="space-y-6">
            ...
            <button className="w-full mt-8 py-3 rounded-xl bg-white/5 border border-white/10 text-xs font-bold text-white hover:bg-white/10 transition-all flex items-center justify-center gap-2">
          ...
          <div className="p-6 rounded-3xl bg-amber-500/10 border border-amber-500/20">
            ...
            <p className="text-sm text-gray-400 leading-tight">Vous avez atteint <span className="text-white font-bold">85%</span> de votre objectif de gains pour cette semaine.</p>
