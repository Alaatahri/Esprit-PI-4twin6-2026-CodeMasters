          ...
          <>
            ...
            <section className="rounded-2xl border border-border dark:border-white/10 bg-white/[0.04] p-5 space-y-4">
              ...
              <dl className="grid sm:grid-cols-2 gap-3 text-sm">
                <div>
                  <dt className="text-foreground dark:text-gray-500">État</dt>
                  <dd className="text-foreground dark:text-white font-medium capitalize">
                    {(() => {
                      const expired =
                ...
                <div>
                  <dt className="text-foreground dark:text-gray-500">Qui a répondu</dt>
                  <dd className="text-foreground dark:text-white font-medium">
                ...
                <div>
                  <dt className="text-foreground dark:text-gray-500">Envoyée le</dt>
                  <dd className="text-foreground dark:text-gray-200">{fmtDate(data.request.sentAt)}</dd>
                </div>
                <div>
                  <dt className="text-foreground dark:text-gray-500">Expire le</dt>
                  <dd className="text-foreground dark:text-gray-200">{fmtDate(data.request.expiresAt)}</dd>
                </div>
                {data.request.respondedAt ? (
                  <div className="sm:col-span-2">
                    <dt className="text-foreground dark:text-gray-500">Réponse le</dt>
                ...
                <div>
                  <dt className="text-foreground dark:text-gray-500">Score de matching</dt>
                  <dd className="text-foreground dark:text-gray-200">
                ...
                <div className="sm:col-span-2">
                  <dt className="text-foreground dark:text-gray-500">Compétences attendues</dt>
                  <dd className="text-foreground dark:text-gray-200">
            ...
            {data.project ? (
              <section className="rounded-2xl border border-border dark:border-white/10 bg-white/[0.04] p-5 space-y-4">
                <h2 className="text-sm font-semibold text-foreground dark:text-white">Projet</h2>
                {data.project.description ? (
                  <p className="text-sm text-muted-foreground dark:text-gray-300 leading-relaxed whitespace-pre-wrap">
                    {data.project.description}
                  </p>
                ) : null}
                <dl className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="flex gap-2">
                    ...
                    <div>
                      <dt className="text-foreground dark:text-gray-500">Lieu</dt>
                      <dd className="text-foreground dark:text-gray-200">
                  ...
                  <div>
                    <dt className="text-foreground dark:text-gray-500">Catégorie / urgence</dt>
                    <dd className="text-foreground dark:text-gray-200">
                  ...
                  <div>
                    <dt className="text-foreground dark:text-gray-500">Surface / type</dt>
                    <dd className="text-foreground dark:text-gray-200">
                      {[
                  ...
                  <div className="flex gap-2">
                    ...
                    <div>
                      <dt className="text-foreground dark:text-gray-500">Budget / dates</dt>
                      <dd className="text-foreground dark:text-gray-200">
                        {[
                  ...
                  <div className="sm:col-span-2 flex gap-2">
                    ...
                    <div>
                      <dt className="text-foreground dark:text-gray-500">Client</dt>
                      <dd className="text-foreground dark:text-gray-200">
                        {userName(
                  ...
                  typeof data.project.expertId === "object" ? (
                    <div className="sm:col-span-2">
                      <dt className="text-foreground dark:text-gray-500">
              ...
              <p className="text-sm text-foreground dark:text-gray-500">Projet non chargé.</p>
            )}
