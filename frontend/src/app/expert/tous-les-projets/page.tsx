  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-foreground dark:text-white">
      <div className="container mx-auto px-4 py-10 max-w-5xl space-y-6">
        <Link
          href="/espace"
          className="inline-flex items-center gap-2 text-sm text-amber-400/90 hover:text-amber-700 dark:text-amber-300 mb-2"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="w-11 h-11 rounded-2xl bg-amber-500/15 border border-amber-500/30 flex items-center justify-center shrink-0">
              <Layers className="w-6 h-6 text-amber-700 dark:text-amber-300" />
            </div>
            <div>
              <h1 className="text-2xl font-bold">Tous les projets</h1>
              <p className="text-sm text-muted-foreground dark:text-gray-400 mt-1 max-w-xl">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-2xl border border-border dark:border-white/15 bg-black/5 dark:bg-white/5 px-4 py-2 text-sm text-foreground/90 dark:text-white/90 hover:bg-black/5 dark:bg-white/10"
            >
              Mes invitations
            </Link>
            <Link
              href="/expert/projets"
              className="inline-flex items-center justify-center rounded-2xl border border-amber-500/35 bg-amber-500/10 px-4 py-2 text-sm font-medium text-amber-900 dark:text-amber-100 hover:bg-amber-500/20"
            >
        ...
        <div className="rounded-2xl border border-border dark:border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-muted-foreground dark:text-gray-300 flex flex-wrap gap-x-6 gap-y-2">
          <span>
            Total dossiers :{" "}
            <strong className="text-foreground dark:text-white">{counts.total}</strong>
          </span>
          <span>
          ...
          <span>
            Matching envoyé :{" "}
            <strong className="text-amber-700 dark:text-amber-300">{counts.withInvite}</strong>
          </span>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-border dark:border-white/15 bg-white/[0.02] px-6 py-12 text-center text-sm text-muted-foreground dark:text-gray-400">
          ...
          <div className="space-y-3">
            {rows.map(({ project: p, matching: m }) => {
              ...
              return (
                <article
                  key={pid}
                  className="rounded-2xl border border-border dark:border-white/10 bg-white/[0.04] p-4 sm:p-5 hover:border-amber-500/25 transition"
                >
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div className="min-w-0 space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <h2 className="text-base font-semibold text-foreground dark:text-white line-clamp-2">
                          {p.titre ?? "Sans titre"}
                        </h2>
                        {p.statut ? (
                          <span className="text-[10px] uppercase tracking-wide px-2 py-0.5 rounded-full border border-border dark:border-white/15 bg-black/5 dark:bg-white/5 text-muted-foreground dark:text-gray-300">
                            {p.statut}
                          </span>
                        ) : null}
                        {p.requestStatus ? (
                      ...
                      {p.ville ? (
                        <p className="text-xs text-foreground dark:text-gray-500 flex items-center gap-1">
                          <MapPin className="w-3.5 h-3.5" />
                          {p.ville}
                        </p>
                      ) : null}
                      <div className="grid sm:grid-cols-2 gap-2 text-xs text-muted-foreground dark:text-gray-400">
                        <p className="flex items-start gap-2">
                          <User className="w-3.5 h-3.5 shrink-0 mt-0.5 text-foreground dark:text-gray-500" />
                          <span>
                            <span className="text-foreground dark:text-gray-500">Client :</span>{" "}
                            <span className="text-foreground dark:text-gray-200">{client}</span>
                            {clientRole ? (
                        ...
                        <p className="flex items-start gap-2">
                          ...
                          <span>
                            ...
                            {assigned ? (
                              ...
                              <span className="text-foreground dark:text-gray-500">non assigné</span>
                            )}
                          </span>
                        </p>
                        <p className="flex items-start gap-2 sm:col-span-2">
                          ...
                          <span>
                            <span className="text-foreground dark:text-gray-500">Matching :</span>{" "}
