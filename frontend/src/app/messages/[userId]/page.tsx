...
export default function MessageThreadPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl flex flex-col min-h-[calc(100vh-8rem)] px-4 py-6">
      <Link
        href="/messages"
        className="inline-flex items-center gap-2 text-sm text-muted-foreground dark:text-gray-400 hover:text-amber-700 dark:text-amber-300 mb-4"
      >
        <ArrowLeft className="w-4 h-4" />
        Conversations
      </Link>

      <div className="flex items-center gap-3 mb-4 pb-4 border-b border-border dark:border-white/10">
        ...
        <div>
          ...
          {partner?.role && (
            <p className="text-xs text-foreground dark:text-gray-500 capitalize">{partner.role}</p>
          )}
        </div>
      </div>
      ...
      {loading ? (
        ...
        <>
                    ...
                    <div
                      className={`max-w-[85%] rounded-2xl px-4 py-2.5 text-sm ${
                        mine
                          ...
                          : "bg-black/5 dark:bg-white/10 text-foreground dark:text-gray-100 border border-border dark:border-white/10"
                      }`}
                    >
                      ...
                      {m.createdAt && (
                        <p
                          className={`text-[10px] mt-1 ${
                            mine ? "text-gray-800/80" : "text-foreground dark:text-gray-500"
                          }`}
                        >
          ...
          <form noValidate onSubmit={onSend} className="flex flex-col sm:flex-row gap-2 pt-2 border-t border-border dark:border-white/10">
