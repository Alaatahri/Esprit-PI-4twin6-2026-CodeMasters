...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-foreground dark:text-white overflow-hidden">
      {/* Effets de fond */}
      <div className="fixed inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0">
          {particles.map((particle, i) => (
            <div
              key={i}
              className="absolute w-1 h-1 bg-black/5 dark:bg-white/20 rounded-full animate-float"
              style={{
                left: particle.left,
                top: particle.top,
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl lg:text-2xl text-muted-foreground dark:text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed"
          >
            Oups ! Il semble que la page que vous cherchez soit en{" "}
            <span className="text-amber-700 dark:text-amber-300 font-semibold">construction</span> ou ait été{" "}
          ...
          <motion.div
            ...
            className="backdrop-blur-2xl bg-black/5 dark:bg-white/10 rounded-3xl p-6 sm:p-8 border border-border dark:border-white/20 mb-12 max-w-2xl mx-auto"
          >
            <div className="flex items-center justify-center gap-4 mb-4">
              <Construction className="w-8 h-8 text-amber-400" />
              <span className="text-amber-700 dark:text-amber-300 font-medium text-lg">En chantier digital</span>
            </div>
          ...
          >
            ...
            <Link href="/contact" className="w-full sm:w-auto">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto px-8 py-4 rounded-2xl backdrop-blur-2xl bg-black/5 dark:bg-white/10 border border-amber-500/30 text-foreground dark:text-white font-semibold hover:border-amber-500/50 hover:bg-black/5 dark:bg-white/20 transition-all duration-300 flex items-center justify-center gap-3 group"
              >
          ...
          >
            <h3 className="text-xl font-bold text-foreground dark:text-white mb-6 flex items-center justify-center gap-3">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                >
                  <h4 className="text-lg font-semibold text-foreground dark:text-white mb-2">{solution.title}</h4>
                  <p className="text-muted-foreground dark:text-gray-300 text-sm">{solution.description}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
            className="mt-16 pt-8 border-t border-border dark:border-white/10"
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <div className="text-left">
                <div className="text-2xl font-bold bg-gradient-to-r from-amber-600 to-amber-900 dark:from-amber-300 dark:to-white bg-clip-text text-transparent">
                  BMP.tn
                </div>
            ...
            <p className="text-muted-foreground dark:text-gray-400 text-sm max-w-md mx-auto mb-6">
            ...
            <div className="text-foreground dark:text-gray-500 text-xs">
