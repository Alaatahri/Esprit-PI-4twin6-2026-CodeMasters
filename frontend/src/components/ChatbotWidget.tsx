...
export function ChatbotWidget() {
  ...
  return (
    <>
      ...
      {/* Chat window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-3rem)] h-[480px] max-h-[70vh] backdrop-blur-2xl bg-gray-900/95 rounded-2xl border border-border dark:border-white/20 shadow-2xl flex flex-col overflow-hidden">
          <div className="px-4 py-3 border-b border-border dark:border-white/10 bg-black/5 dark:bg-white/5">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-semibold text-foreground dark:text-white">Assistant BMP.tn</p>
                <p className="text-xs text-muted-foreground dark:text-gray-400">En ligne</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              >
                <div
                  className={`max-w-[85%] px-4 py-2.5 rounded-2xl ${
                    m.role === "user"
                      ? "bg-amber-500/30 text-foreground dark:text-white"
                      : "bg-black/5 dark:bg-white/10 text-foreground dark:text-gray-200"
                  }`}
                >
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="px-4 py-2.5 rounded-2xl bg-black/5 dark:bg-white/10 text-muted-foreground dark:text-gray-400 text-sm">
                  ...
                </div>
              </div>
            )}
          ...
          <div className="p-3 border-t border-border dark:border-white/10">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 rounded-xl bg-black/5 dark:bg-white/5 border border-border dark:border-white/20 text-foreground dark:text-white placeholder-gray-500 focus:outline-none focus:border-amber-500/50 text-sm"
              />
              <button
                onClick={handleSend}
