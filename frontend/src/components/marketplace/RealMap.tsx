...
export function RealMap({ 
  ...
  if (!isClient) {
    return (
      <div style={{ height, minHeight: '300px' }} className="w-full rounded-xl overflow-hidden border border-border dark:border-white/10 bg-gray-800/50 flex items-center justify-center">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative rounded-xl overflow-hidden border border-border dark:border-white/10 bg-card dark:bg-gray-900" style={{ height, minHeight: '300px' }}>
        <iframe
          key={mapKey}
          src={mapUrl}
        ...
        <div className="absolute bottom-3 left-3 right-3 bg-black/5 dark:bg-black/80 backdrop-blur-sm rounded-lg px-3 py-2 text-xs text-foreground dark:text-white">
      ...
      <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-black/5 dark:bg-white/5 border border-border dark:border-white/10">
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 text-muted-foreground dark:text-gray-400 mb-1">
            <Navigation className="w-4 h-4" />
            <p className="text-xs">Distance</p>
          </div>
          <p className="text-xl font-bold text-foreground dark:text-white">{distance.toFixed(1)} km</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 text-muted-foreground dark:text-gray-400 mb-1">
          ...
          <p className="text-xl font-bold text-foreground dark:text-white">{duration} min</p>
        </div>
      </div>
      ...
      {currentLat && currentLng && (
        <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/30">
          ...
          <p className="text-foreground dark:text-white text-xs mt-1 font-mono">
