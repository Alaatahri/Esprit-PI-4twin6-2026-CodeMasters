    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
        {vehicles.map((vehicle) => {
          const canTransport = poidsTotal <= vehicle.capacite_tonnes;
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <p className="font-medium text-white">{vehicle.nom}</p>
                    {canTransport ? (
                  ...
                  <p className="text-xs text-gray-400">{getVehicleTypeName(vehicle.type)}</p>
                    ...
                    <div className="mt-2 pt-2 border-t border-white/10">
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div>
                          ...
                          <p className="text-white font-medium">{vehicle.prix_base} TND</p>
                        </div>
                        <div>
                          <p className="text-gray-500">Prix au km</p>
                          <p className="text-white font-medium">{vehicle.prix_km} TND/km</p>
                        </div>
                      </div>
                    </div>
                  )}
