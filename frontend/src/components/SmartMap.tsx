...
export default function SmartMap({ delivery }: SmartMapProps) {
  ...
  if (!mounted) return (
    <div className="h-[400px] w-full bg-card dark:bg-gray-900 animate-pulse rounded-[2.5rem] flex items-center justify-center text-foreground dark:text-gray-500">
  ...
  return (
    <div className="h-[400px] w-full relative">
      ...
      {/* Légende flottante */}
      <div className="absolute bottom-4 left-4 z-[1000] p-3 rounded-xl bg-gray-900/90 backdrop-blur-md border border-border dark:border-white/10 text-[10px] space-y-2">
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-orange-500"></div>
          <span className="text-muted-foreground dark:text-gray-300 font-bold uppercase">Zone de travaux</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-blue-500"></div>
          <span className="text-muted-foreground dark:text-gray-300 font-bold uppercase">Alerte météo</span>
        </div>
      </div>
    </div>
  );
