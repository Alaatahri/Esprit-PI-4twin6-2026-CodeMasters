...
export default function SiteFooter() {
  ...
  return (
    <footer className="mt-auto border-t border-border bg-background text-muted-foreground dark:border-white/10 dark:bg-gradient-to-b dark:from-gray-950 dark:to-black dark:text-gray-400">
      <div className="container mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="mt-5 space-y-2 text-sm text-muted-foreground dark:text-gray-500">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>Support Monday to Friday</span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-border dark:border-white/10 pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-muted-foreground/80 dark:text-gray-600">
            © {year} BMP.tn — Digital construction. All rights reserved.
          </p>
          <nav
            className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs"
            aria-label="Informations légales"
          >
            <span className="text-muted-foreground dark:text-gray-500">Legal</span>
            <span className="text-muted-foreground/50 dark:text-gray-700" aria-hidden>
              ·
            </span>
            <span className="text-muted-foreground dark:text-gray-500">Privacy</span>
            <span className="text-muted-foreground/50 dark:text-gray-700" aria-hidden>
              ·
            </span>
            <span className="text-muted-foreground dark:text-gray-500">Cookies</span>
          </nav>
        </div>
      </div>
    </footer>
